...
class TestSimpleInventoryInit:
    ...
    async def test_async_setup_entry_first_entry(self, mock_hass, mock_config_entry):
        ...
        with patch('custom_components.simple_inventory.SimpleInventoryCoordinator') as mock_coord_class, \
            ...
            expected_service_calls = [
                call(DOMAIN, SERVICE_UPDATE_ITEM,
                     mock_service_handler.async_update_item, schema=ANY),
                call(DOMAIN, SERVICE_ADD_ITEM,
                     mock_service_handler.async_add_item, schema=ANY),
                call(DOMAIN, SERVICE_REMOVE_ITEM,
                     mock_service_handler.async_remove_item, schema=ANY),
                call(DOMAIN, SERVICE_INCREMENT_ITEM,
                     mock_service_handler.async_increment_item, schema=ANY),
                call(DOMAIN, SERVICE_DECREMENT_ITEM,
                     mock_service_handler.async_decrement_item, schema=ANY),
            ]
    ...
    @pytest.mark.asyncio
    async def test_async_setup_entry_second_entry(self, mock_hass, mock_config_entry, mock_config_entry_2):
    ...
    @pytest.mark.asyncio
    async def test_async_setup_entry_data_loading_failure(self, mock_hass, mock_config_entry):
    ...
    @pytest.mark.asyncio
    async def test_async_setup_entry_platform_setup_failure(self, mock_hass, mock_config_entry):
    ...
    @pytest.mark.asyncio
    async def test_async_unload_entry_platform_unload_failure(self, mock_hass, mock_config_entry):
    ...
    @pytest.mark.asyncio
    async def test_async_unload_entry_empty_domain_data(self, mock_hass, mock_config_entry):
    ...
    async def test_service_registration_schemas(self, mock_hass, mock_config_entry):
        ...
        with patch('custom_components.simple_inventory.SimpleInventoryCoordinator') as mock_coord_class, \
                patch('custom_components.simple_inventory.TodoManager') as mock_todo_class, \
                patch('custom_components.simple_inventory.ServiceHandler') as mock_service_class, \
                patch('custom_components.simple_inventory.ADD_ITEM_SCHEMA') as mock_add_schema, \
                patch('custom_components.simple_inventory.UPDATE_ITEM_SCHEMA') as mock_update_schema, \
                patch('custom_components.simple_inventory.REMOVE_ITEM_SCHEMA') as mock_remove_schema, \
                patch('custom_components.simple_inventory.QUANTITY_UPDATE_SCHEMA') as mock_quantity_schema:
    ...
    @pytest.mark.asyncio
    async def test_domain_data_persistence_across_entries(self, mock_hass, mock_config_entry, mock_config_entry_2):
