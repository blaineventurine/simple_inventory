...
class TestTodoManager:
    ...
    @pytest.mark.asyncio
    async def test_get_incomplete_items_service_success(self, todo_manager, sample_todo_items):
    ...
    @pytest.mark.asyncio
    async def test_check_and_add_item_case_insensitive_duplicate(self, todo_manager, sample_item_data):
