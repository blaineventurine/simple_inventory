...
class TestServiceHandler:
    ...
    def test_init(self, mock_hass, mock_coordinator, mock_todo_manager):
        ...
        with patch('custom_components.simple_inventory.services.InventoryService') as mock_inventory_service, \
                patch('custom_components.simple_inventory.services.QuantityService') as mock_quantity_service:
    ...
    @pytest.mark.asyncio
    async def test_async_add_item(self, mock_hass, mock_coordinator, mock_todo_manager, mock_service_call):
    ...
    @pytest.mark.asyncio
    async def test_async_remove_item(self, mock_hass, mock_coordinator, mock_todo_manager, mock_service_call):
    ...
    @pytest.mark.asyncio
    async def test_async_update_item(self, mock_hass, mock_coordinator, mock_todo_manager, mock_service_call):
        ...
        with patch('custom_components.simple_inventory.services.InventoryService') as mock_inventory_service, \
            ...
            mock_inventory_instance.async_update_item.assert_called_once_with(
                mock_service_call)

    @pytest.mark.asyncio
    async def test_async_increment_item(self, mock_hass, mock_coordinator, mock_todo_manager, mock_service_call):
        """Test async_increment_item delegates to quantity service."""
        with patch('custom_components.simple_inventory.services.InventoryService'), \
                patch('custom_components.simple_inventory.services.QuantityService') as mock_quantity_service:
            ...
            mock_quantity_instance.async_increment_item.assert_called_once_with(
                mock_service_call)

    @pytest.mark.asyncio
    async def test_async_decrement_item(self, mock_hass, mock_coordinator, mock_todo_manager, mock_service_call):
        ...
        with patch('custom_components.simple_inventory.services.InventoryService'), \
            ...
            mock_quantity_instance.async_decrement_item.assert_called_once_with(
                mock_service_call)

    @pytest.mark.asyncio
    async def test_async_add_item_exception_propagation(self, mock_hass, mock_coordinator, mock_todo_manager, mock_service_call):
    ...
    @pytest.mark.asyncio
    async def test_async_increment_item_exception_propagation(self, mock_hass, mock_coordinator, mock_todo_manager, mock_service_call):
    ...
    @pytest.mark.asyncio
    async def test_multiple_service_calls(self, mock_hass, mock_coordinator, mock_todo_manager):
    ...
    def test_exports(self):
        ...
        expected_exports = ["ServiceHandler",
                            "InventoryService", "QuantityService"]
        assert __all__ == expected_exports

    def test_import_structure(self):
        """Test that imports work correctly."""
        from custom_components.simple_inventory.services import ServiceHandler, InventoryService, QuantityService
    ...
    @pytest.mark.asyncio
    async def test_service_handler_isolation(self, mock_hass, mock_coordinator, mock_todo_manager):
        ...
        with patch('custom_components.simple_inventory.services.InventoryService') as mock_inventory_service, \
            ...
            service_handler1 = ServiceHandler(
                mock_hass, mock_coordinator, mock_todo_manager)
            service_handler2 = ServiceHandler(
                mock_hass, mock_coordinator, mock_todo_manager)
