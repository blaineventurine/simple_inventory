...
class TestInventoryService:
    ...
    @pytest.mark.asyncio
    async def test_async_add_item_minimal_data(self, inventory_service, basic_service_call, mock_coordinator):
    ...
    @pytest.mark.asyncio
    async def test_async_add_item_coordinator_exception(self, inventory_service, add_item_service_call, mock_coordinator, caplog):
    ...
    @pytest.mark.asyncio
    async def test_async_remove_item_not_found(self, inventory_service, basic_service_call, mock_coordinator, caplog):
    ...
    @pytest.mark.asyncio
    async def test_async_remove_item_coordinator_exception(self, inventory_service, basic_service_call, mock_coordinator, caplog):
    ...
    @pytest.mark.asyncio
    async def test_async_update_item_not_found(self, inventory_service, update_item_service_call, mock_coordinator, caplog):
    ...
    @pytest.mark.asyncio
    async def test_async_update_item_coordinator_update_fails(self, inventory_service, update_item_service_call, mock_coordinator, caplog):
    ...
    @pytest.mark.asyncio
    async def test_async_update_item_coordinator_exception(self, inventory_service, update_item_service_call, mock_coordinator, caplog):
